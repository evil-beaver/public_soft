...
Процедура ЗафиксироватьКурсВалютыНаДату(Валюта,КурсВалюты,ДатаКурса)
	...
	ОкругленныйКурсВалюты = Окр(КурсОтносительноВалютыЕВро,4,РежимОкругления.Окр15как20);
	
	Если ОкругленныйКурсВалюты <> КурсОтносительноВалютыЕВро Тогда
		
		КурсОтносительноВалютыЕВро = КурсОтносительноВалютыЕВро;
